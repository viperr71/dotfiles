...
; (gtk_accel_path "<Actions>/ThunarActions/uca-action-1580507157496100-1" "")
...
; (gtk_accel_path "<Actions>/ThunarActions/uca-action-1579901573799628-1" "")
; (gtk_accel_path "<Actions>/ThunarWindow/view-side-pane-shortcuts" "<Primary>b")
; (gtk_accel_path "<Actions>/ThunarWindow/contents" "F1")
; (gtk_accel_path "<Actions>/ThunarWindow/close-window" "<Primary>q")
; (gtk_accel_path "<Actions>/ThunarStandardView/cut" "<Primary>x")
; (gtk_accel_path "<Actions>/ThunarWindow/switch-previous-tab" "<Primary>Page_Up")
; (gtk_accel_path "<Actions>/ThunarActions/uca-action-1580507157496108-2" "")
; (gtk_accel_path "<Actions>/ThunarActions/uca-action-1579898563427645-1" "")
