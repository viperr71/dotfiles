...
def main():
        ...
        c = ['%{{F#ff4500}}{}%{{F-}}'.format(BAR_CHAR),
             '%{{F#ff4400}}{}%{{F-}}'.format(BAR_CHAR),
             '%{{F#ff4600}}{}%{{F-}}'.format(BAR_CHAR),
             '%{{F#ff4700}}{}%{{F-}}'.format(BAR_CHAR),
             '%{{F#ff4800}}{}%{{F-}}'.format(BAR_CHAR),
             '%{{F#ff4900}}{}%{{F-}}'.format(BAR_CHAR),
             '%{{F#ff5400}}{}%{{F-}}'.format(BAR_CHAR),
             '%{{F#ff5500}}{}%{{F-}}'.format(BAR_CHAR),
        ...
        for sample in monitor:
             ...
             bar_pad = '%{{F#671b00}}{}%{{F-i}}'.format(BAR_PAD_CHAR)
             if sample > BAR_LEN:
                sample = BAR_LEN
             if args.right:
